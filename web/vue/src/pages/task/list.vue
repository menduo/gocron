  ...
  <el-container>
    ...
    <el-main>
      ...
      <el-table
        ...
        <el-table-column prop="protocol" :formatter="formatProtocol" label="方式" width="60">
        </el-table-column>
        <el-table-column label="状态" v-if="this.isAdmin" width="60">
          <template slot-scope="scope">
            <el-switch
        ...
        <el-table-column label="状态" v-else width="60">
          <template slot-scope="scope">
            <el-switch
              v-if="scope.row.level === 1"
              v-model="scope.row.status"
        ...
        <el-table-column label="操作" width="250" v-if="this.isAdmin">
          <template slot-scope="scope">
            <el-row>
              <el-button type="primary" @click="toEdit(scope.row)" title="编辑">编</el-button>
              <el-button type="success" @click="runTask(scope.row)" title="手动执行任务">手</el-button>
              <el-button type="info" @click="jumpToLog(scope.row)" title="日志">日</el-button>
              <el-button type="danger" @click="remove(scope.row)" title="删除">删</el-button>
            </el-row>
          </template>
        </el-table-column>
      </el-table>
